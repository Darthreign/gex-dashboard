...
# Configuration lue UNIQUEMENT depuis les variables d'environnement Windows
# (aucun fichier lisible, par choix). À poser en persistant, scope User :
#   [Environment]::SetEnvironmentVariable("DISCORD_BOT_TOKEN", "...", "User")
# puis ROUVRIR un terminal (une variable persistante n'est lue qu'au démarrage
# du process).
